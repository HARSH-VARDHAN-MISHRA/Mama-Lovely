...
const Login = () => {
    ...
    const handleSubmit = async (event) =>{
        ...
        try {
            ...
            localStorage.setItem('mamaLovelyToyToken',response.data.token);
            localStorage.setItem('mamaLovelyToyUser', JSON.stringify(response.data.user));
            navigate('/')
        ...
        <section className="my-3 login-page">
            <div className="container">
                <div className="row login">
                    ...
                    <div className="col-md-6 mx-auto form-div text-center">
