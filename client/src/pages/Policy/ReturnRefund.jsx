    ...
    return (
        <>
            <section className="bread">
                <div className="container">
                    <nav aria-label="breadcrumb ">
                        <h1 className='breadcrumb-title'>Return & Refund Policy</h1>
            ...
            <div className="container policy py-4">
                <p className="mb-4">
                    We want you to be completely satisfied with your purchase from Mama Lovely Toy. If you are not satisfied with your purchase for any reason, you may return it for a refund or exchange within 4-5 days of receiving your order.
                </p>
